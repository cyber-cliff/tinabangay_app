...
class CheckoutEmployee extends Component{
  ...
  addPersonInContact(){
    if(this.state.newPerson.name === null || this.state.newPerson.department === null){
      this.setState({
  ...
  addRelatedQuestion(indexParam){
    if(indexParam == 0 && this.state.office === null){
      this.setState({
        errorMessage: 'Visited office field is required.'
      })
      return
    }else if(indexParam == 1 && this.state.after === null){
      this.setState({
        errorMessage: 'Location you want to visit field is required.'
      })
      return
    }else if(indexParam == 2 && this.state.irregular === null){
      this.setState({
        errorMessage: 'Irregular field is required.'
      })
      return
    }
    ...
    if(indexParam == 0){
      ...
      answer.push(this.state.after)
    }else if(indexParam == 2){
      answer.push(this.state.irregular)
    }
        ...
        <View style={{
          ...
          flexDirection: 'row'
            ...
            <TextInput
              ...
              placeholder={'Visited offices today'}
            />
        ...
        <View style={{
          ...
          flexDirection: 'row'
            ...
            <TextInput
              ...
              onChangeText={(after) => this.setState({
                after
              })}
              value={this.state.after}
              placeholder={'Type places here'}
            />
        ...
        <View style={{
          ...
          flexDirection: 'row'
            ...
            <TextInput
              ...
              onChangeText={(irregular) => this.setState({
                irregular
              })}
              value={this.state.irregular}
              ...
              return(
                <View style={{
                  ...
                  <View style={{
                    ...
                    <Text style={{
                      color: Color.black
                    }}>{item.department.toUpperCase()}</Text>
        ...
        <View style={{
          ...
          paddingBottom: 10
            ...
            <TextInput
              ...
              value={this.state.newPerson.department}
